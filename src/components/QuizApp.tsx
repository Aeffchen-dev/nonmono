...
export function QuizApp() {
  ...
  return (
    <div className="h-screen h-[100svh] bg-background overflow-hidden">
      ...
      {/* Main Quiz Container */}
      <div className="h-[calc(100vh-60px)] h-[calc(100svh-60px)] flex items-start justify-center px-4 pt-4 pb-4 overflow-hidden">
        <div className="w-full h-[calc(100vh-92px)] h-[calc(100svh-92px)]">
          {loading ? (
