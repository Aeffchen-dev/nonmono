    ...
    >
      ...
      <div className="ml-8 h-full flex flex-col justify-center pl-4 pr-4 lg:pl-8 lg:pr-8">
        ...
        <div className="flex-1 flex items-start justify-start text-left pt-16 w-full">
          <h1 className="text-3xl md:text-4xl lg:text-4xl font-normal text-foreground leading-tight break-words overflow-wrap-anywhere word-break w-full max-w-full hyphens-auto" style={{ hyphens: 'auto' }}>
            {question.question}
          </h1>
        </div>
