    ...
    >
      ...
      <div className="ml-8 h-full flex flex-col justify-center px-8 lg:px-4">
        ...
        <div className="flex-1 flex items-start justify-start text-left pt-16 w-full">
          <h1 className="text-3xl md:text-4xl lg:text-4xl font-normal text-foreground leading-tight w-full max-w-full" style={{ hyphens: 'auto', overflowWrap: 'break-word', wordBreak: 'normal' }} lang="de">
            {question.question}
          </h1>
        </div>
